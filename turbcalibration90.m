voltage = [1.68 1.65 1.60 1.55 1.45]; %percent of max fan speed
%REQUIRES ATTENTION
...
%REQUIRES ATTENTION
xstart = 1.4; %start and end values to cover the range
%REQUIRES ATTENTION
xend = 1.7; %of the measured data
...
title('Turbidity vs Voltage for 90 Degree Photodiode');
legend('Measured Data','Best Fit','Best Fit + Uncertainty','Best Fit - Uncertainty');
%REQUIRES ATTENTION
text(1.5, 0, ['Turbidity = ' num2str(coefficients(1)) ' * Voltage + ' num2str(coefficients(2))]);
